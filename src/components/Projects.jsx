...
const Projects = () => {
  ...
  return (
    <div className="text-center pt-[4.7%] min-h-screen bg-slate-100 dark:bg-slate-900 -z-10 ">
      <div className="flex flex-wrap justify-around items-center">
        {currentPost.map((project, idx) => {
          return (
            <>
              <div
                ...
                />
                <div className="px-3">
                  <div className="text-xl font-bold mt-2  dark:text-yellow-300 text-orange-400">
                    {project.title}
                  </div>
